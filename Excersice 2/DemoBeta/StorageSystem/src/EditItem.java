...
public class EditItem extends JDialog {
	...
	public EditItem(Item item) {
		...
		formattedNameTextField.setValue(item.getName());
		...
		formattedBarcodeTextField.setValue(item.getBarcode());
		...
		formattedPriceTextField.setValue(item.getPrice());
		...
		formattedCountTextField.setValue(item.getCount());
